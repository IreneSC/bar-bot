...
static const float scanning_z = .10;//m
static const float scanning_r = .50;//m
static float scanning_speed = -0.5;//rad/s
static const float scanning_limit_left = 0.0;//rad
static const float scanning_limit_right = -M_PI/4.0;//rad

static ros::Time last_cup_detection(-1);
...
int main(int argc, char **argv) {
    ...
    cup_detection_subscriber = nh.subscribe(target_gripper_state_topic, 10,
        &processCupPoint);
